...
class Options:
    ...
    def _initial(self):
        ...
        # self.parser.add_argument('--load',           type=str, default='D:\\Workspace\\3d_pose_baseline_pytorch-master\\3d_pose_baseline_pytorch-master\\checkpoint\\test\\ckpt_best.pth.tar', help='path to load a pretrained checkpoint')
        self.parser.add_argument('--load',           type=str, default='', help='path to load a pretrained checkpoint')

        # self.parser.add_argument('--test',           dest='test', action='store_false', help='test')
        ...
        self.parser.add_argument('--procrustes',     dest='procrustes', action='store_false', help='use procrustes analysis at testing')
